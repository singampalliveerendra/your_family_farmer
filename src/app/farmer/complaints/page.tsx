...
const TYPE_OPTIONS = (L: (en: string, te: string) => string) => [
  { value: 'payment_issue', label: L('Payment / settlement', 'చెల్లింపు సమస్య') },
  ...
  return (
    <main className="min-h-screen bg-gray-50 pb-16">
      <div className="bg-green-900 px-4 pt-6 pb-10">
        <Link href="/farmer/dashboard" className="text-green-300 text-sm flex items-center gap-1 mb-4">{L('← Dashboard', 'డాష్‌బోర్డ్')}</Link>
    ...
    <div className="fixed inset-0 z-50 bg-black/40 flex items-end sm:items-center justify-center p-4" onClick={onClose}>
      <div className="bg-white rounded-2xl w-full max-w-md p-5" onClick={(e) => e.stopPropagation()}>
        ...
        <textarea
          ...
          placeholder={L('e.g. Payment for order not settled', 'ఉదా: ఆర్డర్‌కు చెల్లింపు అందలేదు')}
